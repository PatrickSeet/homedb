...
urlpatterns = patterns('',
 ...
 url(r'^admin/', include(admin.site.urls)),
    ...
    url(r'^propertynotes/(?P<property_id>\w+)/edit/$', 'homedbapp.views.edit_propertynotes', name='edit_propertynotes'),
    url(r'^propertynotes/new/$', 'homedbapp.views.new_propertynotes', name='new_propertynotes'),
